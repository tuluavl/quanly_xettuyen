...
class MauImportGiayBao(models.Model):
    ...
    pt2_vsat_diemmon1 = models.DecimalField(max_digits=4, decimal_places=2, null=True, blank=True)
    pt2_vsat_mamon2 = models.CharField(max_length=20, null=True, blank=True)
    pt2_vsat_diemmon2 = models.DecimalField(max_digits=4, decimal_places=2, null=True, blank=True)
    pt2_vsat_mamon3 = models.CharField(max_length=20, null=True, blank=True)
    pt2_vsat_diemmon3 = models.DecimalField(max_digits=4, decimal_places=2, null=True, blank=True)
    pt2a_diemtbthpt = models.DecimalField(max_digits=4, decimal_places=2, null=True, blank=True)
